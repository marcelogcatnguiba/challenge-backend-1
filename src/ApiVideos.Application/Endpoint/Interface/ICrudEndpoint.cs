...
{
    static abstract Task<IResult> GetByIdAsync(
        long id,
        IRepository<TEntity> repository,
        CancellationToken cancellationToken);

    static abstract Task<IResult> GetAsync(
        int? pageNumber,
        int? pageSize,
        IRepository<TEntity> repository,
        IMapper mapper,
    ...
    static abstract Task<IResult> UpdateAsync(
        TRequest request,
        IRepository<TEntity> repository,
        IMapper mapper,
        CancellationToken cancellationToken);

    static abstract Task<IResult> DeleteAsync(
        long id,
        IRepository<TEntity> repository,
        CancellationToken cancellationToken);
}
